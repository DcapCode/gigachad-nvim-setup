...
{
    {
        ...
        config = function()
            ...
            dap.adapters.coreclr =  {
                type = 'executable',
                command = '~/bin/debuggers/netcoredbg/netcoredbg',
            ...
            map('n', '<Leader>dr', function() require'dap'.repl.open() end, 'Open debugger REPL')
            map('n', '<Leader>dl', function() require'dap'.run_last() end, 'Run last debug configuration')
            dapui.setup({
